...
<head>
    ...
    <title>Strategy Games - AmbaGaming</title>
    ...
    <style>
        ...
        .category-header {
            background: linear-gradient(rgba(15, 25, 35, 0.9), rgba(15, 25, 35, 0.9)),
                        url('https://source.unsplash.com/1600x400/?strategy-game') no-repeat center center;
...
<body>
    ...
    <div class="category-header">
        <div class="container">
            <h1 class="text-center mb-3">Strategy Games</h1>
            <p class="text-center lead">Uji kemampuan strategi Anda dengan koleksi game terbaik kami</p>
        </div>
    </div>
        ...
        <div class="container">
            <a class="navbar-brand brand-logo" href="../index.php">
                <div class="logo-container">
                    ...
                    <i class="fas fa-crown logo-icon ms-1"></i>
                </div>
        ...
        <div class="row g-4">
            ...
            $games = [
                [
                    ...
                    'description' => 'Game strategi 4X legendaris dengan gameplay yang mendalam.',
                    'price' => 'Rp 599.000',
                    'rating' => '9.4/10',
                    'platform' => 'PC, PS4, Xbox One, Switch',
                    'release_date' => '21 Oktober 2016'
                ],
                [
                    'title' => 'Total War: Warhammer III',
                    'image' => './images/total.jpg',
                    'description' => 'Strategi epik dengan pertempuran skala besar dalam dunia fantasi.',
                    'price' => 'Rp 749.000',
                    'rating' => '9.2/10',
                    'platform' => 'PC',
                    'release_date' => '17 Februari 2022'
                ],
                [
                    'title' => 'XCOM 2',
                    'image' => './images/xcom.jpg',
                    'description' => 'Strategi taktis melawan invasi alien dengan konsekuensi permanen.',
                    'price' => 'Rp 499.000',
                    'rating' => '9.3/10',
                    'platform' => 'PC, PS4, Xbox One, Switch',
                    'release_date' => '5 Februari 2016'
                ],
                [
                    'title' => 'Age of Empires IV',
                    'image' => './images/age.jpg',
                    'description' => 'RTS klasik dengan pertempuran historis yang spektakuler.',
                    'price' => 'Rp 649.000',
                    'rating' => '9.0/10',
                    'platform' => 'PC',
                    'release_date' => '28 Oktober 2021'
                ],
                [
                    'title' => 'Crusader Kings III',
                    'image' => './images/crusader.jpg',
                    'description' => 'Simulasi dinasti abad pertengahan dengan intrik politik yang kompleks.',
                    'price' => 'Rp 549.000',
                    'rating' => '9.1/10',
                    'platform' => 'PC, PS5, Xbox Series X/S',
                    'release_date' => '1 September 2020'
                ],
                [
                    'title' => 'Frostpunk',
                    'image' => './images/frost.jpg',
                    'description' => 'Strategi survival dengan keputusan moral yang menantang.',
                    'price' => 'Rp 299.000',
                    'rating' => '8.9/10',
                    'platform' => 'PC, PS4, Xbox One',
                    'release_date' => '24 April 2018'
                ]
            ];
